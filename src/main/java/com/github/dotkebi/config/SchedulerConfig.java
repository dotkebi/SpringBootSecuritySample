...
import com.github.dotkebi.job.TestJob;
...
/**
 * @see https://github.com/davidkiss/spring-boot-quartz-demo/blob/master/src/main/java/com/kaviddiss/bootquartz/SchedulerConfig.java
 */
@Configuration
...
//        factory.setTriggers(sampleJobTrigger);
    ...
    public SimpleTriggerFactoryBean sampleJobTrigger(
            ...
            , @Value("${testJob.frequency}") long frequency
    ) {
